...
(function($) {
	...
	$.fn.nivoSlider = function(options) {
		...
		return this.each(function() {
			...
			slider.append(
				$('<div class="slideroverlay"></div><div class="borderframetop"></div><div class="borderframebottom"></div><div class="borderframeright"></div>')
			);

			//Process initial  caption
			if(vars.currentImage.attr('title') != undefined){
