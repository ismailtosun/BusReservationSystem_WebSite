                                ...
                                <table cellspacing="0" cellpadding="1" border="0" style="border-collapse:collapse;">
                                    <tbody><tr>
                                        <td><table cellpadding="0" border="0">
                                                <tbody><tr>
                                                    <td align="center" colspan="2">Giriş Yap</td>
                                                </tr><tr>
                                                    <td align="right"><label >Kullanıcı Adi:</label></td><td><input name="username" type="text" ></td>
                                                </tr><tr>
                                                    <td align="right"><label>Şifre:</label></td><td><input name="password" type="password"></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" colspan="2"><input type="submit" name="submit" value="Giriş Yap" ></td>
                                                </tr>
                                                </tbody></table></td>
                                    </tr>
                                    </tbody>
